...
public struct GradientColors {
    public static let orange = GradientColor(start: Color(hexString: "#EC2301"), end: Color(hexString: "#FF782C"))
    public static let blue = GradientColor(start: Color(hexString: "#7B75FF"), end: Color(hexString: "#6FEAFF"))
...
public struct Styles {
    public static let lineChartStyleOne = ChartStyle(
        ...
        accentColor: Color(hexString: "#EC2301"),
        secondGradientColor: Color(hexString: "#FF782C"),
    ...
    public static let barChartStyleNeonBlueLight = ChartStyle(
        backgroundColor: Color.white,
        accentColor: Color(hexString: "#6FEAFF"),
        secondGradientColor: Color(hexString: "#7B75FF"),
        textColor: Color.black,
        legendTextColor: Color.gray,
        dropShadowColor: Color.gray)
    ...
    public static let pieChartStyleOne = ChartStyle(
        backgroundColor: Color.white,
        accentColor: Color(hexString: "#FF782C"),
        secondGradientColor: Color(hexString: "#EC2301"),
        textColor: Color.black,
        legendTextColor: Color.gray,
        dropShadowColor: Color.gray)
...
public class ChartStyle {
    ...
    public init(formSize: CGSize){
        ...
        self.accentColor = Color(hexString: "#EC2301")
